...
<head>
    ...
    <meta name="keywords"
        content="Рыболовные, рыбалка, базы, отдыха, астрахань, астраханская, область, низовья, волги, дельта, каспийские, раскаты, цены, 2026, году" />
            ...
            <div class="collapse navbar-collapse" id="main-menu">
                <ul id="menu-main-menu" class="navbar-nav">
                    ...
                    <div class="row mobile-header-items">
                        <div class="col">
                            <a href="#" data-bs-toggle="modal" data-bs-target="#addBaseModal"
                                class="menu-item nav-link pt-2">Добавить&nbsp;базу</a>
                        </div>
                        <div class="col">
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <h3 class="home-description">Мы собрали для Вас полезную информацию о рыбалке и отдыхе в
                        Астраханской области</h3>
                </div>
            </div>
        </div>
    </header>
    ...
    <section class="single-article bg-white py-5">
        <div class="container">
            <div class="row">
                ...
                <aside class="col col-md-4 d-flex flex-column">
                    <div class="header">
                        <h2 class="article-block-title mb-3">Другие статьи о Рыбалке в Астрахани </h2>
                        <h3 class="mb-3">Представляем с гордостью!</h3>
                    ...
                    <div class="content d-flex flex-column">
                        <?php
                        /* Выбираем только 3 статьи */
                        $result = mysqli_query($connection, "SELECT * FROM `articles` LIMIT 3");
    ...
    <section class="contacts-section pt-md-5">
        <div class="container"><!-- section .container -->
                    ...
                    <nav id="contacts-menu-1" class="navbar-light">
                        ...
                        <div class="row h-100 justify-content-between align-items-center d-none d-lg-flex">
                                ...
                                <nav id="contacts-menu-2" class="navbar navbar-expand-xl navbar-light">
                                    <div class="collapse navbar-collapse">
                                        <ul id="menu-main-menu-2" class="navbar-nav  mb-2 mb-lg-0">
                                            <li class="menu-item nav-item">
                                                <a href="index.html" class="nav-link" aria-current="page">Рыболовные
                                                    базы</a>
                                            </li>
                                            <li class="nav-item d-none d-xl-inline">
                                                <span class="nav-link px-2">
                            ...
                            <div class="col-3 d-flex justify-content-end">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#addBaseModal"
                                            class="contact-link pt-2">Добавить&nbsp;базу</a>
                                    </div>
                                    <div class="col">
                                        <a href="/adm" class="btn btn-outline-success" type="button">Войти</a>
                                    </div>
                        ...
                        <div class="row d-lg-none mobile-contacts-block">
                            ...
                            <div class="col-12 mb-2">
                                <p class="footer-text ">Мы регулярно ищем и добавляем на сайт полезную информацию о
                                    рыбалке в Астрахани. Посещайте наш сайт регулярно, если Вас интересует тема отдыха и
                                    рыбалки в Астраханской области. Добавьте сайт в закладки, чтобы не потерять его и
                                    всегда иметь возможность быстро перейти к интересующей Вас информации (нажмите
                                    одновременно Ctrl+D).</p>
                            </div>
                            ...
                            <div class="col-12 mb-1 ">
                                <a href="/archive-articles.php" class="contact-link active ps-0 "
                                    aria-current="page">Рыбалка в Астрахани</a>
                            </div>
                            <div class="col-12 mb-1 ">
                            ...
                            <div class="col-12 mb-1 ">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#messageModal"
                                    class="contact-link ps-0" aria-current="page">Написать нам</a>
                            </div>
                            <div class="col-12 mb-2 ">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#addBaseModal"
                                    class="contact-link ps-0" aria-current="page">Добавить базу</a>
                            </div>
                            <div class="col">
            ...
            <div class="row pt-2 d-none d-lg-flex justify-content-center">
                <div class="col-10">
                    <p class="footer-text text-center">Мы регулярно ищем и добавляем на сайт полезную информацию о
                        рыбалке в Астрахани. Посещайте наш сайт регулярно, если Вас интересует тема отдыха и рыбалки в
                        Астраханской области. Добавьте сайт в закладки, чтобы не потерять его и всегда иметь возможность
            ...
            <div class="row footer-link-block">
                <div class="col text-center">
                    ...
                    <a data-bs-toggle="modal" data-bs-target="#messageModal" class="footer-text-link link-offset-1"
                        href="#"> Написать нам</a>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col  footer-block-text">
                        ...
                        <div class="footer-text">©<?php echo date('Y'); ?>г. | <a href="https://астраханские-базы.рф "
                                class="footer-text-link link-offset-3 text-decoration-none">астраханские-базы.рф</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                <form method="post" action="/mls/add_base_mls.php">
                    ...
                    <div class="modal-body">
                        <p><small>Спасибо за проявленный интерес к нашему сервису. В данный момент сервис находится в
                                процессе разработки и Вы не можете добавить Вашу ,базу самостоятельно. Но мы с
                                удовольствием добавим ее туда сами в ближайшее время и сообщим Вам об этом
                                дополнительно. Всю информацию мы возьмем с Вашего сайта. А как только будет готов личный
                                кабинет пользователя, в котором Вы сможете редактировать всю информацию самостоятельно,
                                мы вышлем Вам логин и пароль для входа.</small></p>
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" class="form-control mb-3 mb-md-0" name="site"
                    ...
                    <div class="modal-footer" style="justify-content: flex-start;">
                        ...
                        <a type="button" data-bs-toggle="modal" data-bs-target="#addBaseModal"
